...
public class TempChessThread extends Thread {
	...
	public TempChessThread(Socket socket) {
		super("TempChessThread");
	...
	public String createNewGame(String packet) throws Exception
	{
		...
		ServerPusher.pushNotification(data[3], "New Game", data[1] + " has challenged you to a game!");
	...
	public GameBoard updateBlack(String packet) throws Exception
	{
		...
		if(found)
		{
			...
			ServerPusher.pushNotification(currentGame.getWhiteTeam(), "Ready to Play", currentGame.getBlackTeam() + " is ready to play!");
	...
	public String makeMove(String packet) 
	{
		...
		if(found)
		{
			...
			if(proceed)
			{
				...
				ServerPusher.pushNotification(myGameBoard.getWhoseTurn(), "Your Move", "A game is waiting on you...");
	...
	private String startSkirmish(String packet)
	{
		...
		if(found)
		{
			...
			{
				ServerPusher.pushNotification(myGameBoard.getBlackTeam(), "Skirmish", myGameBoard.getWhiteTeam() + " has challenged your move!");
			}
			else
			{
				ServerPusher.pushNotification(myGameBoard.getWhiteTeam(), "Skirmish", myGameBoard.getBlackTeam() + " has challenged your move!");
			}
